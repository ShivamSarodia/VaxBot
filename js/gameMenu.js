...
function initCustomMenu() {
    ...
    d3.select("#customNodes").text("Nodes: " + 75)
    d3.select("#customDegree").text("Neighbors: " + 3  + "ea.")
    d3.select("#customVaccines").text("Vaccines: " + 10)
    d3.select("#customRefusers").text("Refusers: " + 0.05)
    d3.select("#customOutbreaks").text("Outbreaks: " + 2)
...
var maxVax = 75;
// WAS CAUSING ERRORS, SO I REMOVED THIS
// $(function() {
//     $( "#nodeSlider").slider({
//         range: "min",
//         min: 10,
...
//         }
//     });
//     $( "#refuserSlider").slider("value", 0.05)
// });
